...
- The Flyway configuration needs a JDBC datasource. `datasources.defaul.url` configures one. See https://micronaut-projects.github.io/micronaut-sql/latest/guide/#jdbc[Micronaut JDBC] for more information.
